        ...
        <table role="presentation" width="560" cellspacing="0" cellpadding="0" style="max-width:560px;width:100%;">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td style="padding:0 0 24px;">
                    ...
                    <p style="margin:12px 0 0;color:#94a3b8;font-size:15px;line-height:1.7;">Thanks for signing up for SiteLaunch! Please verify your email address by clicking the button below.</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0 0 24px;">
          ...
          <tr>
            <td style="padding:24px 0 0;text-align:center;">
              <p style="margin:0;color:#475569;font-size:12px;line-height:1.5;">Sent from SiteLaunch</p>
            </td>
          </tr>
        </table>
      </td>
...
(
  'welcome',
  'Welcome to SiteLaunch',
  'Welcome to SiteLaunch, {{company_name}}!',
...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <meta name="color-scheme" content="light dark" />
  <title>Welcome to SiteLaunch</title>
</head>
<body style="margin:0;padding:0;background-color:#0b1326;font-family:-apple-system,BlinkMacSystemFont,''Segoe UI'',Roboto,sans-serif;-webkit-font-smoothing:antialiased;">
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color:#0b1326;">
    <tr>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td style="padding:0 0 24px;">
                    ...
                    <p style="margin:12px 0 0;color:#94a3b8;font-size:15px;line-height:1.7;">Your SiteLaunch account is all set up and ready to go. {{plan_line}}</p>
                  </td>
                </tr>
                <tr>
...
(
  'partner_invite',
  'Partner Invitation',
  'You''ve been invited to join SiteLaunch',
            ...
            <td style="background:#131b2e;border-radius:16px;padding:36px 32px;border:1px solid rgba(105,108,248,0.15);">
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                ...
                <tr>
                  <td style="padding:0 0 24px;">
                    <p style="margin:0;color:#94a3b8;font-size:15px;line-height:1.7;">Hi {{partner_name}},</p>
                    <p style="margin:12px 0 0;color:#94a3b8;font-size:15px;line-height:1.7;">{{inviter_name}} has invited you to join SiteLaunch as a <strong style="color:#e2e8f0;">{{role}}</strong>. Click below to accept the invitation and set up your account.</p>
                  </td>
                </tr>
                <tr>
                  <td style="padding:0 0 24px;">
